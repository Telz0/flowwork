      ...
      <header className="bg-card border-b border-border sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            <img src="https://media.base44.com/images/public/69f08744cf810ff9c68b76fc/cfd7db800_logo_above_and_beyond.png" alt="Above & Beyond" className="h-9 w-auto flex-shrink-0" />
            <div className="min-w-0">
              <span className="font-bold text-lg text-foreground tracking-tight block">ABND</span>
              <span className="hidden sm:block text-xs text-muted-foreground">I</span>
            </div>
          </div>
